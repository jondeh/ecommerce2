...
const Customize = () => {
    ...
    const surveyPosition = [
        {component: <ProductQuestion {...{productAnswer, setProductAnswer, handleClick}}/>, description: "What are you interested in?"}, 
        {component: <HomeQuestion {...{homeAnswer, setHomeAnswer, handleClick}}/>, description: "Next: a little bit about your house."},
        {component: <WhoQuestion {...{whoAnswer, setWhoAnswer, handleClick}}/>, description: "A little bit about who you're protecting."}, 
        {component: <BugQuestion {...{bugAnswer, setBugAnswer, handleClick, addBug}}/>, description: "People in XYZ typically have these pests.  Select the pests you need help with."}, 
        {component: <SprayerQuestion {...{sprayerAnswer, setSprayerAnswer, handleClick}}/>, description: "Do you already have a sprayer?"}
    ];
